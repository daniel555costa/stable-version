create view VER_CONTA_MOVIMENTO_PAGAMENTO as
SELECT ITEM.IPAY_ID AS "ID",
     ...
     FROM T_ITEMPAYMENT ITEM
        ...
        INNER JOIN VER_ALL_ACCOUNT AC ON ITEM.IPAY_ACCOUNT_ID = AC.ID
        INNER JOIN T_PAYMENT PAY ON ITEM.IPAY_PAY_ID = PAY.PAY_ID
        INNER JOIN T_ACCOUNT PAYAC ON PAY.PAY_ACCOUNT_ID = PAYAC.COUNT_ID
